...
\usepackage{gensymb}
% Used for clickable ToC links.
\usepackage{hyperref}
% Used to embed Python code within LaTeX.
\usepackage{pythontex} 
% Used for tables that extend across multiple pages.
\usepackage{longtable}
% For printing the creation date of the document.
\usepackage{datetime2}
% For typesetting subscripts.
\usepackage{fixltx2e}
% TODO: Rerun to get outlines right or use package `bookmark'.
\usepackage{bookmark}
...
\fancyhead[LE,RO]{\leftmark\\\rightmark}
\fancyhead[RE,LO]{Bootstrap Performance Data\\PA-28-236, Piper Dakota}
\fancyfoot[LE,RO]{v.\today}
...
\include{dakota.performance_charts.tex}
