...
% Helps the table of contents refresh when using PythonTex.
\usepackage{bookmark}
...
\include{dakota.normal_procedures.tex}
\include{dakota.emergency_procedures.tex}
